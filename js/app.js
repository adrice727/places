$(function(){
  ...
  var map, service, currentLocationMarker;
  ...
  var mapOptions = {
    ...
    // Default to Market/Embarcadero
    defaultLocation: {lat: 37.79496, lang: -122.394358} 
  };
  
  //Initialize map and get map objects
  var mapService = new MapService();
 
  mapService.initialize(mapOptions)
  .then(function(){
    map = mapService.getMapsObject('map');
    service = mapService.getMapsObject('places');
  ...
  function executeSearch(query) {
    var request = {
      location: mapOptions.settings.center,
      radius: '50',
      query: query
    };
